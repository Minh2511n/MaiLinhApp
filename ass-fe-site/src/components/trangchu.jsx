  ...
  <div className="search-box">
    ...
    <div className="search-form">
      <div className="form-group">
        <label htmlFor="departure">Nơi đi</label>
      ...
      <div className="form-group">
        <label htmlFor="passengers">Số lượng vé</label>
        <input type="number" id="passengers" min="1" placeholder="Nhập số lượng vé" />
      </div>
      <button>Tìm Chuyến</button>
    </div>
    <div className="search-advanced">
      <label>
        <input type="checkbox" /> Hiển thị chuyến đi khứ hồi
      </label>
      <label>
        <input type="checkbox" /> Tìm chuyến ngay
      </label>
    </div>
  </div>
</section>
      ...
      <div className="container">
        ...
        {/* Thêm thông tin số liệu và ảnh lớn */}
