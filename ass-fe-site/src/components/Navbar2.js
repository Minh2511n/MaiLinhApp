  ...
  return (
    <nav className="navbar-container" >
      <ul id="navbar">
        ...
        <li><NavLink to="/trangchu" activeClassName="active" style={{ marginLeft: '-1.5cm' }}>Trang chủ</NavLink></li>
        <li><NavLink to="/lichtrinh" activeClassName="active">Lịch Trình</NavLink></li>
        <li><NavLink to="/tracuu" activeClassName="active">Tra cứu vé</NavLink></li>
        <li><NavLink to="/tintuc" activeClassName="active">Tin Tức</NavLink></li>
        <li><NavLink to="/hoadon" activeClassName="active">Hóa Đơn</NavLink></li>
        <li><NavLink to="/lienhe" activeClassName="active">Liên Hệ</NavLink></li>
        <li><NavLink to="/vechungtoi" activeClassName="active">Về Chúng Tôi</NavLink></li>
        <li className="dropdown-container" onClick={toggleDropdown}>
          <NavLink to="/login" activeClassName="active">Đăng nhập</NavLink>
          {isDropdownOpen && (
