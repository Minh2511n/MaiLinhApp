    ...
    <Timchuyen/>
        ...
        <div className="filter">
          ...
          <div className="filter">
            ...
            <div className="checkbox-group">
              <label className="checkbox-label">
                <input
                  type="checkbox" className="checkbox-input" id="seat" />
                <div className="checkbox-custom"></div>
                <span className="checkbox-text">
                  Ghế
                  <span className="checkbox-checkmark"></span>
      ...
      <div className="custom-container-loc">
        ...
        <div className="icon-container">
          <div
            className={`icon-gia-re custom-icon ${selectedIcons.includes('money') ? 'active' : ''}`}
          ...
          <div
            className={`icon-gio-khoi-hanh custom-icon ${selectedIcons.includes('clock') ? 'active' : ''}`}
          ...
          <div
            className={`icon-ghe-trong custom-icon ${selectedIcons.includes('seat') ? 'active' : ''}`}
        ...
        <div className="chuyenxe-loc">
          <div className="info-container-loc">
            ...
            <div className="location-details">
              ...
              <span className="travel-duration" style={{ marginLeft: '-0.08cm' }}><span style={{ marginLeft: '-0.3cm' }}>20 giờ </span><br /><span className="small-text">(Asian/Ho Chi Minh)</span></span>
              <span className="separator">.  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  </span>
          ...
          <div className="special-note text-yellow">
            <span className="underline">Lưu ý</span>: Quý Khách đang chọn tuyến xe có lộ trình đi Cao tốc Phan Thiết Dầu Giây- Cao tốc Long Thà
          ...
          <div className="availability-info">
            ...
            <span onClick={() => handleSeatModal("trip1")}> 
            Chọn chuyến
          </span>
            </button>
          </div>
        ...
        <div className="availability-info">
          ...
          <button type="button" className="custom-button hidden sm:block">
          <span onClick={() => handleSeatModal("trip2")}> 
          Chọn chuyến
        </span>
          </button>
        </div>
        ...
        {isSeatModalOpen && (
          <div className="seat-selection" id="seatModal">
            <h2>Chọn Ghế</h2>
            <div className="modal-close" onClick={closeSeatModal}>
              X
            </div>
            <div className="seat-map">
              <h3>Tất cả tầng</h3>
              <div className="seats">{createSeatMap(currentTrip)}</div>
            </div>
            <button className="btn-select-seats" onClick={selectSeats}>
              Xác nhận chọn ghế
            </button>
          </div>
        )}
